defmodule Deputy.MyTest do
  ...
  describe "locations/1" do
    test "retrieves user's locations", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/location"
  ...
  describe "contact_address/1" do
    test "retrieves user's contact address", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/contactaddress"
  ...
  describe "all_contact_addresses/1" do
    test "retrieves all user's contact addresses", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/contactaddress/all"
  ...
  describe "colleagues/1" do
    test "retrieves user's colleagues", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/colleague"
  ...
  describe "rosters/1" do
    test "retrieves user's rosters", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/roster"
  ...
  describe "leave/1" do
    test "retrieves user's leave requests", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/leave"
  ...
  describe "unavailability/1" do
    test "retrieves user's unavailability", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/unavail"
  ...
  describe "notifications/1" do
    test "retrieves user's notifications", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/notification"
  ...
  describe "training/1" do
    test "retrieves user's training", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/training"
  ...
  describe "memos/1" do
    test "retrieves user's memos", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/memo"
  ...
  describe "tasks/1" do
    test "retrieves user's tasks", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/tasks"
  ...
  describe "complete_task/2" do
    test "completes a task", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/tasks/#{task_id}/do"
  ...
  describe "timesheets/1" do
    test "retrieves user's timesheets", %{client: client} do
      ...
      |> expect(:request, fn req ->
        assert req.method == :get
        assert req.url == "https://test.deputy.com/api/v1/my/timesheets"
  ...
  describe "location!/2" do
    test "returns unwrapped location", %{client: client} do
      ...
      Deputy.HTTPClient.Mock
      |> expect(:request, fn req ->
        assert req.url == "https://test.deputy.com/api/v1/my/location/1"
        {:ok, response_body}
      end)
  ...
  describe "complete_task!/2" do
    test "returns unwrapped task completion result", %{client: client} do
      ...
      Deputy.HTTPClient.Mock
      |> expect(:request, fn req ->
        assert req.url == "https://test.deputy.com/api/v1/my/tasks/1/do"
        {:ok, response_body}
      end)
