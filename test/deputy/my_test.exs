defmodule Deputy.MyTest do
  ...
  describe "me/1" do
    test "retrieves user information", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/me"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "setup/1" do
    test "retrieves setup information", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/setup"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "locations/1" do
    test "retrieves user's locations", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/location"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "contact_address/1" do
    test "retrieves user's contact address", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/contactaddress"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "all_contact_addresses/1" do
    test "retrieves all user's contact addresses", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/contactaddress/all"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "colleagues/1" do
    test "retrieves user's colleagues", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/colleague"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "rosters/1" do
    test "retrieves user's rosters", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/roster"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "leave/1" do
    test "retrieves user's leave requests", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/leave"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "unavailability/1" do
    test "retrieves user's unavailability", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/unavail"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "notifications/1" do
    test "retrieves user's notifications", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/notification"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "training/1" do
    test "retrieves user's training", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/training"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "memos/1" do
    test "retrieves user's memos", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/memo"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "tasks/1" do
    test "retrieves user's tasks", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/tasks"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "timesheets/1" do
    test "retrieves user's timesheets", %{client: client} do
      ...
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               method: :get,
                               url: "https://test.deputy.com/api/v1/my/timesheets"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "location!/2" do
    test "returns unwrapped location", %{client: client} do
      ...
      Deputy.HTTPClient.Mock
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               url: "https://test.deputy.com/api/v1/my/location/1"
                             } ->
        {:ok, response_body}
      end)
  ...
  describe "complete_task!/2" do
    test "returns unwrapped task completion result", %{client: client} do
      ...
      Deputy.HTTPClient.Mock
      |> expect(:request, fn %Deputy.HTTPClient.Request{
                               url: "https://test.deputy.com/api/v1/my/tasks/1/do"
                             } ->
        {:ok, response_body}
      end)
